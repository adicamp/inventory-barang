                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body shadow">
                            ...
                            <?php if ($alert) : ?>
                                <div id="alert-message" class="alert alert-<?= $alert_type; ?> alert-dismissible fade show" role="alert">
                                    <strong><?= $alert; ?></strong>
                                    ...
                                    <?php foreach ($barang_barang as $i => $barang) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="hapus.php?id=<?= $barang["id_barang"] ?>" onclick="return confirm('yakin?');">
